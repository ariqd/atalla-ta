...
<div class="tb-content tb-style1">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <form action="{{ @$customer ? route('customers.update', $customer) : route('customers.store') }}"
                    method="POST">
                    @csrf
                    {{ @$customer ? method_field('PUT') : '' }}
                    <div class="form-group">
                        <label for="name">Nama</label>
                        <input type="text" class="form-control" id="name" name="name" placeholder="Nama pembeli"
                            autofocus value="{{ @$customer ? $customer->name : '' }}">
                    </div>
                    <div class="form-group">
                        <label for="address">Alamat</label>
                        <input type="text" class="form-control" id="address" name="address" placeholder="Alamat"
                            autofocus value="{{ @$customer ? $customer->address : '' }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="phone" name="phone" placeholder="No. Telp" autofocus
                            value="{{ @$customer ? $customer->phone : '' }}">
                    </div>
                    <div class="form-group">
                        <label for="status">Status</label>
                        <div class="custom-control custom-radio">
                            <input type="radio" id="customRadio6" name="status" class="custom-control-input"
                                value="Distributor" {{ @$customer->status == 'Distributor' ? 'checked' : '' }}>
                        ...
                        <div class="custom-control custom-radio">
                            <input type="radio" id="customRadio5" name="status" class="custom-control-input"
                                value="Agen" {{ @$customer->status == 'Agen' ? 'checked' : '' }}>
