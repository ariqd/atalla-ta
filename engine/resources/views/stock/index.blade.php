...
<div class="tb-content tb-style1">
    <div class="tb-padd-lr-30 tb-uikits-heading mb-3 mt-2">
        <h2 class="tb-uikits-title">Stok</h2>
        @if(Auth::user()->role == 'owner')
            <a href="{{ route('stocks.create') }}" class="btn btn-success btn-sm">Tambah</a>
        @endif
    </div>
                        ...
                        <table id="tb-no-locked" class="table row-border order-column dataTable no-footer table-hover" role="grid" aria-describedby="tb-no-locked_info">
                            <thead>
                                <tr role="row">
                                    ...
                                    <th class="sorting_asc" tabindex="0" aria-controls="tb-no-locked" aria-label="Produk: activate to sort column descending">Produk</th>
                                    <th class="sorting" tabindex="0" aria-controls="tb-no-locked" aria-label="Harga: activate to sort column ascending">Warna</th>
                                    <th class="sorting_asc" tabindex="0" aria-controls="tb-no-locked" aria-label="Size: activate to sort column descending">Size</th>
                                    <th class="sorting" tabindex="0" aria-controls="tb-no-locked" aria-label="Qty: activate to sort column ascending">Qty</th>
                                    <th class="sorting" tabindex="0" aria-controls="tb-no-locked" aria-label="Hold Qty: activate to sort column ascending">Hold Qty</th>
                                    @if(Auth::user()->role == 'owner')
