                        ...
                        <table id="tb-no-locked"
                            ...
                            <thead>
                                <tr role="row">
                                    ...
                                    <th class="sorting_asc" tabindex="0" aria-controls="tb-no-locked"
                                        aria-label="Produk: activate to sort column descending">Produk</th>
                                    <th class="sorting" tabindex="0" aria-controls="tb-no-locked"
                                        aria-label="Harga: activate to sort column ascending">Warna</th>
                                    <th class="sorting_asc" tabindex="0" aria-controls="tb-no-locked"
                                        aria-label="Size: activate to sort column descending">Size</th>
                                    <th class="sorting" tabindex="0" aria-controls="tb-no-locked"
                                        aria-label="Kategori: activate to sort column ascending">Qty</th>
                                    <th class="sorting" tabindex="0" aria-controls="tb-no-locked"
