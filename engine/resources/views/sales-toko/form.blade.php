                                    ...
                                    <table class="table stripe row-border order-column no-footer table-hover"
                                        ...
                                        <tbody id="tbody">
                                            ...
                                            <tr id="item-id-{{ $detail->id }}">
                                                ...
                                                <td class="align-middle text-right" style="width: 25%">
                                                    <span
                                                        id="subtotal-text-{{ $detail->id }}">Rp{{ number_format($detail->subtotal, 0, ',', '.') }}</span>
